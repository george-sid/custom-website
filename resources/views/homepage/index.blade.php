                            ...
                            <nav>
                                <ul>
                                    <li class="has-dropdown">
                                        ...
                                        <ul class="submenu">
                                            <li><a href="index.html">Wind Energy</a></li>
                                            <li><a href="index-two.html">Solar Energy</a></li>
                                            <li><a href="index-three.html">Renewable Energy</a></li>
                                            <li><a href="index-four.html">Hydro Power</a></li>
                                            <li><a href="index-five.html">Solar Shop</a></li>
                                            <li><a href="index-six.html">Solar Solution</a></li>
                                            <li><a href="one-page-one.html">One Page One</a></li>
                                            <li><a href="one-page-two.html">One Page Two</a></li>
                                            <li><a href="one-page-three.html">One Page Three</a></li>
                                            <li><a href="one-page-four.html">One Page Four</a></li>
                                            <li><a href="one-page-five.html">One Page five</a></li>
                                        </ul>
                                    </li>
                                    <li class="has-dropdown">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="banner-solari-2-content ptb--200 ptb_sm--130">
                                    <span class="pre"> <span>Welcome</span> To Solari</span>
                                    <h1 class="banner-title">
                                        Harnessing the Wind and Sun for Future
                                    </h1>
                                    <p class="disc">In a world where renewable resources have become paramount <br> we believe in the boundless power of nature to shape.</p>
                                    <div class="button-solari-banner-area">
                                        <a href="aboutus.html" class="rts-btn btn-primary">Learn More</a>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="solari-about-left-content">
                    <div class="title-area-left mt  skew-up">
                        ...
                        <h2 class="title">
                            Our mission is to make <br> solar energy accessible
                        </h2>
                    </div>
                            ...
                            <div class="call-button">
                                ...
                                <div class="info">
                                    ...
                                    <a href="tel:+4733378901">
                                        <h6 class="title">+236-3256.21456</h6>
                                    </a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-lg-6 mt_md--50 mt_sm--40">
                <div class="thumbnail-solari-about">
                    <img src="assets/images/about/22.png" alt="about">
                    <div class="vedio-icone">
                        <a class="video-play-button play-video" href="#">
                            <span></span>
                            <p class="text">
        ...
        <div class="row g-24 mt--20">
            <div class="col-xl-3 col-lg-4 col-sm-6 col-sm-6 col-12">
                ...
                <div class="single-solari-service-start">
                    ...
                    <a href="service-details.html" class="read-more-btn">Read More<i class="fa-regular fa-arrow-right"></i></a>
                </div>
        ...
        <div class="row g-24 mt--20">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                ...
                <div class="single-solari-steps-start">
                    ...
                    <div class="content">
                        <h5 class="title">Installation amp Maintenance</h5>
                    </div>
                </div>
                <!-- single solari steps area end -->
            </div>
            ...
            <div class="col-lg-12">
                <div class="cta-solari-wrapper">
                    <div class="left-area">
                        ...
                        <h4 class="title skew-up">Get Free Consultancy or <br> +1 (800) 123 446 559</h4>
                    </div>
                    ...
                    <div class="swiper mySwiper-h-2-c">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                ...
                                <div class="single-case-ac">
                                    <a href="project-details.html" class="thumbnail">
                                        <img src="assets/images/project/12.jpg" alt="air-condition">
                                    </a>
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="single-case-ac">
                                    <a href="project-details.html" class="thumbnail">
                                        <img src="assets/images/project/24.jpg" alt="air-condition">
                                    </a>
                                    <div class="inner-content">
                                        <div class="inner">
                                            <span class="pre">CHALLENGE</span>
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="single-case-ac">
                                    <a href="project-details.html" class="thumbnail">
                                        <img src="assets/images/project/25.jpg" alt="air-condition">
                                    </a>
                                    <div class="inner-content">
                                        <div class="inner">
                                            <span class="pre">CHALLENGE</span>
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="single-case-ac">
                                    <a href="project-details.html" class="thumbnail">
                                        <img src="assets/images/project/26.jpg" alt="air-condition">
                                    </a>
                                    <div class="inner-content">
                                        <div class="inner">
                                            <span class="pre">CHALLENGE</span>
                    ...
                    <div class="inner-content-solari-blog">
                        ...
                        <div class="body">
                            <a href="blog-details.html">
                                <h5 class="title">Solar Training Program Series: Why is Remote Energy Focused on Training Solar Educators?</h5>
                            </a>
                            <a href="blog-details.html" class="rts-btn btn-primary">Read More</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-6">
                ...
                <div class="single-blog-solaric-sm">
                    ...
                    <div class="inner-content-solari-blog">
                        ...
                        <div class="body">
                            <a href="blog-details.html">
                                <h5 class="title">2021 Batterman Award honors <br> Brad Burkhart Meyer Green</h5>
                            </a>
                            <a href="blog-details.html" class="rts-btn btn-primary">Read More</a>
                        </div>
                    </div>
                ...
                <div class="single-footer-one-wrapper two">
                    <div class="single-footer-component first">
                        ...
                        <div class="body mt--45">
                            <p class="disc">
                                Solari is a leading solar company dedicated <br> to revolutionizing the way we generate and <br> consume energy.
                            </p>
                            ...
                            <div class="footer-contact-wrapper-2">
                                ...
                                <div class="contact-single">
                                    ...
                                    <div class="info-content ml-dec-5">
                                        <a href="tel:+4733378901">
                                            <h6 class="title">+23 5825-32535</h6>
                                        </a>
                                ...
                                <div class="contact-single">
                                    ...
                                    <div class="info-content">
                                        <a href="mailto:someone@example.com">
                                            <h6 class="title">dril.sola@gmail.com</h6>
                                        </a>
                                ...
                                <div class="contact-single">
                                    ...
                                    <div class="info-content">
                                        <a href="#">
                                            <h6 class="title">1058 Helton Ave, Stky</h6>
                                        </a>
